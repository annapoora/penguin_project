...
@st.cache()
def prediction(svc_model,island,bill_length_mm,bill_depth_mm,flipper_length_mm,body_mass_g,sex):
...
# Design the App
st.title('The classification Models for prediction of Penguin Species')
...
if st.sidebar.button('Predict'):
  if classifier == 'Support Vector Machine':
    species_type = prediction(svc_model, isl, bill_length_mm, bill_depth_mm, flipper_length_mm, body_mass, sex)
    score = svc_score

  elif classifier =='Logistic Regression':
    species_type = prediction(log_reg, isl, bill_length_mm, bill_depth_mm, flipper_length_mm, body_mass, sex)
    score = log_reg_score

  else:
    species_type = prediction(rf_clf, isl, bill_length_mm, bill_depth_mm, flipper_length_mm, body_mass, sex)
    score = rf_clf_score
